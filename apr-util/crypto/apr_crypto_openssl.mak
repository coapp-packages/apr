...
ALL : "$(OUTDIR)\apr_crypto_openssl-1.dll"

!ELSE 

ALL : "libaprutil - Win32 Release" "$(OUTDIR)\apr_crypto_openssl-1.dll"
...
CPP=cl.exe
CPP_PROJ=/nologo /MD /W3 /Zi /O2 /Oy- /I "../include" /I "../../apr/include" /I "../include/private" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "APU_DSO_MODULE_BUILD" /D APU_HAVE_OPENSSL=1 /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\apr_crypto_openssl_src" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib advapi32.lib ws2_32.lib mswsock.lib ole32.lib libeay32.lib ssleay32.lib /nologo /base:"0x6F100000" /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\apr_crypto_openssl-1.pdb" /debug /machine:IX86 /out:"$(OUTDIR)\apr_crypto_openssl-1.dll" /implib:"$(OUTDIR)\apr_crypto_openssl-1.lib" /MACHINE:X86 /opt:ref 
LINK32_OBJS= \
...
$(DS_POSTBUILD_DEP) : "libaprutil - Win32 Release" "$(OUTDIR)\apr_crypto_openssl-1.dll"
...
ALL : "libaprutil - Win32 Debug" "$(OUTDIR)\apr_crypto_openssl-1.dll"
...
CPP=cl.exe
CPP_PROJ=/nologo /MDd /W3 /Zi /Od /I "../include" /I "../../apr/include" /I "../include/private" /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "APU_DSO_MODULE_BUILD" /D APU_HAVE_OPENSSL=1 /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\apr_crypto_openssl_src" /FD /D /EHsc /c 
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib advapi32.lib ws2_32.lib mswsock.lib ole32.lib libeay32.lib ssleay32.lib /nologo /base:"0x6F100000" /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\apr_crypto_openssl-1.pdb" /debug /machine:IX86 /out:"$(OUTDIR)\apr_crypto_openssl-1.dll" /implib:"$(OUTDIR)\apr_crypto_openssl-1.lib" /MACHINE:X86 
LINK32_OBJS= \
	"$(INTDIR)\apr_crypto_openssl.obj" \
	"$(INTDIR)\apr_crypto_openssl-1.res" \
...
$(DS_POSTBUILD_DEP) : "libaprutil - Win32 Debug" "$(OUTDIR)\apr_crypto_openssl-1.dll"
...
ALL : "libaprutil - x64 Release" "$(OUTDIR)\apr_crypto_openssl-1.dll"
...
CPP=cl.exe
CPP_PROJ=/nologo /MD /W3 /Zi /O2 /Oy- /I "../include" /I "../../apr/include" /I "../include/private" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "APU_DSO_MODULE_BUILD" /D APU_HAVE_OPENSSL=1 /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\apr_crypto_openssl_src" /FD /D /c 
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib advapi32.lib ws2_32.lib mswsock.lib ole32.lib libeay32.lib ssleay32.lib /nologo /base:"0x6F100000" /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\apr_crypto_openssl-1.pdb" /debug /machine:IX86 /out:"$(OUTDIR)\apr_crypto_openssl-1.dll" /implib:"$(OUTDIR)\apr_crypto_openssl-1.lib" /MACHINE:X64 /opt:ref 
LINK32_OBJS= \
	"$(INTDIR)\apr_crypto_openssl.obj" \
	"$(INTDIR)\apr_crypto_openssl-1.res" \
...
$(DS_POSTBUILD_DEP) : "libaprutil - x64 Release" "$(OUTDIR)\apr_crypto_openssl-1.dll"
...
ALL : "libaprutil - x64 Debug" "$(OUTDIR)\apr_crypto_openssl-1.dll"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib advapi32.lib ws2_32.lib mswsock.lib ole32.lib libeay32.lib ssleay32.lib /nologo /base:"0x6F100000" /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\apr_crypto_openssl-1.pdb" /debug /machine:IX86 /out:"$(OUTDIR)\apr_crypto_openssl-1.dll" /implib:"$(OUTDIR)\apr_crypto_openssl-1.lib" /MACHINE:X64 
LINK32_OBJS= \
	"$(INTDIR)\apr_crypto_openssl.obj" \
	"$(INTDIR)\apr_crypto_openssl-1.res" \
...
$(DS_POSTBUILD_DEP) : "libaprutil - x64 Debug" "$(OUTDIR)\apr_crypto_openssl-1.dll"
...
"$(INTDIR)\apr_crypto_openssl-1.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\apr_crypto_openssl-1.res" /i "../include" /i "../../apr/include" /i "\tmp\apr-util" /d DLL_NAME="apr_crypto_openssl" /d "NDEBUG" /d "APU_VERSION_ONLY" $(SOURCE)
...
"$(INTDIR)\apr_crypto_openssl-1.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\apr_crypto_openssl-1.res" /i "../include" /i "../../apr/include" /i "\tmp\apr-util" /d DLL_NAME="apr_crypto_openssl" /d "_DEBUG" /d "APU_VERSION_ONLY" $(SOURCE)
