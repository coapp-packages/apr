...
ALL : "xml - Win32 Release" "preaprutil - Win32 Release" ".\include\private\apu_select_dbm.h" ".\include\private\apu_config.h" ".\include\apu_want.h" ".\include\apu.h" ".\include\apr_ldap.h" "$(OUTDIR)\aprutil-1.lib"

!ENDIF 

!IF "$(RECURSE)" == "1" 
CLEAN :"preaprutil - Win32 ReleaseCLEAN" "xml - Win32 ReleaseCLEAN" 
!ELSE 
CLEAN :
!ENDIF 
...
CPP_PROJ=/nologo /MD /W3 /Zi /O2 /Oy- /I "./include" /I "../apr/include" /I "./include/private" /I "../apr-iconv/include" /I "./dbm/sdbm" /I "%ProgramData%/include/expat" /D "NDEBUG" /D "APR_DECLARE_STATIC" /D "APU_DECLARE_STATIC" /D "API_DECLARE_STATIC" /D "APU_USE_SDBM" /D "HAVE_SQL_H" /D "WIN32" /D "_WINDOWS" /Fo"$(INTDIR)\\" /Fd"$(OUTDIR)\aprutil-1" /FD /c 
...
ALL : "xml - Win32 Debug" "preaprutil - Win32 Debug" ".\include\private\apu_select_dbm.h" ".\include\private\apu_config.h" ".\include\apu_want.h" ".\include\apu.h" ".\include\apr_ldap.h" "$(OUTDIR)\aprutil-1.lib"

!ENDIF 

!IF "$(RECURSE)" == "1" 
CLEAN :"preaprutil - Win32 DebugCLEAN" "xml - Win32 DebugCLEAN" 
!ELSE 
CLEAN :
!ENDIF 
	-@erase "$(INTDIR)\apr_base64.obj"
...
CPP_PROJ=/nologo /MDd /W3 /Zi /Od /I "./include" /I "../apr/include" /I "./include/private" /I "../apr-iconv/include" /I "./dbm/sdbm" /I "%ProgramData%/include/expat" /D "_DEBUG" /D "APR_DECLARE_STATIC" /D "APU_DECLARE_STATIC" /D "API_DECLARE_STATIC" /D "APU_USE_SDBM" /D "HAVE_SQL_H" /D "WIN32" /D "_WINDOWS" /Fo"$(INTDIR)\\" /Fd"$(OUTDIR)\aprutil-1" /FD /EHsc /c 
...
ALL : "xml - x64 Release" "preaprutil - x64 Release" ".\include\private\apu_select_dbm.h" ".\include\private\apu_config.h" ".\include\apu_want.h" ".\include\apu.h" ".\include\apr_ldap.h" "$(OUTDIR)\aprutil-1.lib"

!ENDIF 

!IF "$(RECURSE)" == "1" 
CLEAN :"preaprutil - x64 ReleaseCLEAN" "xml - x64 ReleaseCLEAN" 
!ELSE 
CLEAN :
!ENDIF 
	-@erase "$(INTDIR)\apr_base64.obj"
...
CPP=cl.exe
#CPP_PROJ=/nologo /MD /W3 /Zi /O2 /Oy- /I "./include" /I "../apr/include" /I "./include/private" /I "../apr-iconv/include" /I "./dbm/sdbm" /I "./xml/expat/lib" /D "NDEBUG" /D "APR_DECLARE_STATIC" /D "APU_DECLARE_STATIC" /D "API_DECLARE_STATIC" /D "APU_USE_SDBM" /D "HAVE_SQL_H" /D "XML_STATIC" /D "WIN32" /D "_WINDOWS" /Fo"$(INTDIR)\\" /Fd"$(OUTDIR)\aprutil-1" /FD /c 
CPP_PROJ=/nologo /MD /W3 /Zi /O2 /Oy- /I "./include" /I "../apr/include" /I "./include/private" /I "../apr-iconv/include" /I "./dbm/sdbm" /I "%ProgramData%/include/expat" /D "APR_DECLARE_STATIC" /D "APU_DECLARE_STATIC" /D "API_DECLARE_STATIC" /D "APU_USE_SDBM" /D "HAVE_SQL_H" /D "WIN32" /D "_WINDOWS" /Fo"$(INTDIR)\\" /Fd"$(OUTDIR)\aprutil-1" /FD /c 
...
ALL : "xml - x64 Debug" "preaprutil - x64 Debug" ".\include\private\apu_select_dbm.h" ".\include\private\apu_config.h" ".\include\apu_want.h" ".\include\apu.h" ".\include\apr_ldap.h" "$(OUTDIR)\aprutil-1.lib"

!ENDIF 

!IF "$(RECURSE)" == "1" 
CLEAN :"preaprutil - x64 DebugCLEAN" "xml - x64 DebugCLEAN" 
!ELSE 
CLEAN :
!ENDIF 
	-@erase "$(INTDIR)\apr_base64.obj"
...
"preaprutil - Win32 Release" : 
   cd ".\build"
   NMAKE /nologo /f NUL
   cd ".."

"preaprutil - Win32 ReleaseCLEAN" : 
   cd ".\build"
   cd ".."

!ELSEIF  "$(CFG)" == "aprutil - Win32 Debug"

"preaprutil - Win32 Debug" : 
   cd ".\build"
   NMAKE /nologo /f NUL
   cd ".."

"preaprutil - Win32 DebugCLEAN" : 
   cd ".\build"
   cd ".."

!ELSEIF  "$(CFG)" == "aprutil - x64 Release"

"preaprutil - x64 Release" : 
   cd ".\build"
   NMAKE /nologo /f NUL
   cd ".."

"preaprutil - x64 ReleaseCLEAN" : 
   cd ".\build"
   cd ".."

!ELSEIF  "$(CFG)" == "aprutil - x64 Debug"

"preaprutil - x64 Debug" : 
   cd ".\build"
   NMAKE /nologo /f NUL
   cd ".."

"preaprutil - x64 DebugCLEAN" : 
   cd ".\build"
   cd ".."
